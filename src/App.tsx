...
const FiMenu: any = require('react-icons/fi').FiMenu;
const FiX: any = require('react-icons/fi').FiX;
const FiSearch: any = require('react-icons/fi').FiSearch;
const FiLogOut: any = require('react-icons/fi').FiLogOut;
const FiDownload: any = require('react-icons/fi').FiDownload;
const FiFileText: any = require('react-icons/fi').FiFileText;
const FiMail: any = require('react-icons/fi').FiMail;
const FiLinkedin: any = require('react-icons/fi').FiLinkedin;
const FiInstagram: any = require('react-icons/fi').FiInstagram;
const FiInfo: any = require('react-icons/fi').FiInfo;
const FiEye: any = require('react-icons/fi').FiEye;
const FiEyeOff: any = require('react-icons/fi').FiEyeOff;
const FiCheck: any = require('react-icons/fi').FiCheck;
const FiArrowLeft: any = require('react-icons/fi').FiArrowLeft;
