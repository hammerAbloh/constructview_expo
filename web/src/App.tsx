        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 gap-4">
            <div>
              ...
              <p className="text-gray-400">Gerencie seus dados, preferências e segurança.</p>
            </div>
            <button className="bg-white/10 hover:bg-white/20 text-white font-bold py-2 px-6 rounded-full border border-white/10 transition-all text-sm">
              Editar Perfil
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              <div className="glass rounded-[2rem] p-8 border border-zinc-800 shadow-xl relative overflow-hidden">
                ...
                <div className="space-y-6 text-base">
                  <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-zinc-800/50 pb-4">
                    ...
                    <span className="font-bold">Admin ConstructView</span>
                  </div>
                  <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-zinc-800/50 pb-4">
                    <span className="text-gray-400">E-mail Corporativo</span>
                    <span className="font-bold">admin@teste.com</span>
                  </div>
                  <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-zinc-800/50 pb-4">
                    <span className="text-gray-400">Cargo</span>
                    <span className="font-bold">Gestor de Investimentos</span>
                  </div>
                  <div className="flex flex-col md:flex-row md:items-center justify-between pb-2">
                    ...
                    <span className="font-bold text-neon-green bg-neon-green/10 border border-neon-green/20 px-4 py-1.5 rounded-full text-sm">Premium Empresarial</span>
                  </div>
                </div>
              </div>
              ...
              <div className="glass rounded-[2rem] p-8 border border-zinc-800 shadow-xl relative overflow-hidden">
                ...
                >
                  {emailEnviado ? <><IconCheck size={18} /> E-mail reenviado com sucesso!</> : <><IconMail size={18} /> Reenviar confirmação</>}
                </button>
              </div>
            </div>

            <div className="space-y-8">
              <div className="glass rounded-[2rem] p-8 border border-zinc-800 shadow-xl">
                <h2 className="text-xl font-bold mb-6 text-white">Segurança</h2>
                <div className="space-y-5">
                  <div className="flex justify-between items-center cursor-pointer group">
                    <div>
                      <p className="font-bold group-hover:text-neon-blue transition">Autenticação 2FA</p>
                      <p className="text-xs text-gray-500">Desativado</p>
                    </div>
                  ...
                  <div className="flex justify-between items-center cursor-pointer group">
                    <div>
                      <p className="font-bold group-hover:text-neon-blue transition">Alertas de Login</p>
                      <p className="text-xs text-gray-500">Ativado para novos IP</p>
                    </div>
                  ...
                  <button className="w-full mt-4 bg-zinc-800/50 hover:bg-zinc-800 text-white border border-zinc-700 py-3 rounded-xl transition text-sm font-bold">
                    Alterar Senha
                  </button>
                </div>
              </div>
              ...
              <div className="glass rounded-[2rem] p-8 border border-zinc-800 shadow-xl">
                <h2 className="text-xl font-bold mb-6 text-white">Últimos Acessos</h2>
                <div className="space-y-4">
                  {[
                    { local: "São Paulo, SP", ip: "192.168.1.1", time: "Hoje, 14:30" },
                    { local: "São Paulo, SP", ip: "192.168.1.1", time: "Ontem, 09:15" },
                    { local: "Campinas, SP", ip: "172.16.0.4", time: "03/05/2026" }
                  ].map((log, i) => (
                    <div key={i} className="flex flex-col border-b border-zinc-800/50 pb-3 last:border-0 last:pb-0">
                      <span className="text-sm font-bold text-gray-200">{log.local}</span>
